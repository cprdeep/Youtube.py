...
#API Key connection
def Api_connect():
    Api_Id="AIzaSyC-guvJlDCJidi1404v2Irp0YvDeMT3QUg"
    api_service_name="youtube"
    api_version="v3"
    youbtube=build(api_service_name,api_version,developerKey=Api_Id)
...
def channels_table(channel_name_s):
    try:
        ...
        # Print the error message from PostgreSQL
        print(f"Error: {e}")
...
channels_table("Some Channel Name")
